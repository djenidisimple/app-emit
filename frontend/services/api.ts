...
export const api = {
  ...
  postBlob: (endpoint: string, data?: unknown, config?: AxiosRequestConfig): Promise<Blob> =>
    axiosInstance.post(endpoint, data, { ...config, responseType: 'blob' }).then((res) => res.data),
